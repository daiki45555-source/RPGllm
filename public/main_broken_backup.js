...
// ========================================
// タイトル画面見切れ修正 (LAYOUT_FIX_APPLIED)
// アンチグラヴィティ君の遺志を継ぐ
// ========================================
function applyLayoutFix() {
    console.log('[LAYOUT_FIX] Applying title screen layout fix...');
    ...
    if (gameContainer) {
        ...
        gameContainer.style.minHeight = 'calc(100vh - 100px)';
    }
    ...
    if (contentLayer) {
        ...
        contentLayer.style.minHeight = 'calc(100vh - 120px)';
        contentLayer.style.paddingTop = '20px';
    }
    
    // introduction セクションを修正
    ...
    if (intro) {
        ...
        intro.style.minHeight = 'calc(100vh - 140px)';
    }
    
    // typewriter-container を修正
    const typewriter = document.querySelector('.typewriter-container');
    if (typewriter) {
        typewriter.style.marginTop = '0';
    ...
    if (titleUI) {
        ...
        titleUI.style.flexDirection = 'column';
        titleUI.style.alignItems = 'center';
        titleUI.style.justifyContent = 'center';
    }
    
    console.log('[LAYOUT_FIX] Layout fix applied!');
}
